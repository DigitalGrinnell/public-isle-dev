...
openssl req -x509 -nodes -days 3650 -newkey rsa:2048 -keyout ../../../config/proxy/ssl-certs/public.localdomain.key -out ../../../config/proxy/ssl-certs/public.localdomain.pem \
	-subj "/C=US/O=Grinnell College Libraries/OU=Domain Control Validated/CN=public.localdomain"
